...
namespace DoDo
{
	FSlateRenderBatch::FSlateRenderBatch(int32_t in_layer, const FShaderParams& in_shader_params, const FSlateShaderResource* in_resource, ESlateDrawPrimitive in_primitive_type, ESlateShader in_shader_type,
