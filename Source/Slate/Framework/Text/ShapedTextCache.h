...
namespace DoDo{
	...
	namespace ShapedTextCacheUtil
	{
		...
		*/
		glm::vec2 measure_shaped_text(const FShapedTextCachePtr& in_shaped_text_cache, const FCachedShapedTextKey& in_run_key, const FTextRange& in_measure_range, const DoDoUtf8String& in_text);
	}
}
